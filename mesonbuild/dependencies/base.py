...
if T.TYPE_CHECKING:
    ...
    from ..build import (
        ...
        StaticLibrary, StructuredSources, ExtractedObjects, GeneratedList,
    )
...
class Dependency(HoldableObject):
    ...
    def generate_link_whole_dependency(self) -> T.Tuple[Dependency, T.List[str]]:
        ...
        new_dep = InternalDependency(self.version, [], self.compile_args, link_args, [], [], self.sources, self.ext_deps, None, [], [])
