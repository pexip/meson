...
class PythonInstallation(_ExternalProgramHolder['PythonExternalProgram']):
    def __init__(self, python: 'PythonExternalProgram', interpreter: 'Interpreter'):
        ...
        self.is_debug = self.interpreter.environment.coredata.get_option(OptionKey('buildtype')) == 'debug'
    ...
    def _find_installation_impl(self, state: 'ModuleState', display_name: str, name_or_path: str, required: bool) -> MaybePythonProg:
        if not name_or_path:
            ...
            if mesonlib.is_windows():
                is_debug = self.interpreter.environment.coredata.get_option(OptionKey('buildtype')) == 'debug'
